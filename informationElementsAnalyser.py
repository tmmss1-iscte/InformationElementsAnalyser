...
from env_variables import db_filepath, show_variation, write_to_file, txt_filepath



# Definitely and Reasonable Varying Bytes/Bits
...
connwifi = sqlite3.connect(db_filepath, timeout=30)
